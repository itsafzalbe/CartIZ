...
stores/views.py
================
All views use a consistent response envelope:
  Success  { "status": "success", "message": "...", "data": {...} }
  Error    { "status": "error",   "message": "..." }

Permissions:
  IsSellerOnly   – must have is_seller=True
  IsMarketOwner  – must own the specific market
  AllowAny       – public discovery / browse endpoints
  IsAuthenticated– review create, follow/unfollow
"""
